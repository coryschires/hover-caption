...
== Smart captions.
If your image has a title attribute, the plugin will use that as the caption. Otherwise it will default to <pre>Click for screenshots</pre>. You can change the default if you like, of course.
